<?
    class my
    {
        ...
        static function GetHotObjavs()
        {
            ...
            $res = self::Return_array(
                CIBlockElement::GetList(null, $filter), null, true, array('NAME', 'ID', 'DETAIL_PICTURE', 'PREVIEW_PICTURE', 'PREVIEW_TEXT'), false
            );
            return $res;
        }
        ...
        static function GetSections($iblock_id)
        {
            ...
            $res = self::Fetch(
                CIBlockSection::GetList(null, $filter),
                false,
                array('NAME', 'ID')
            );
            foreach ($res as &$vol) {
        ...
        static function GetElementsCount($section_id)
        {
            ...
            $res = self::Return_array(
                CIBlockElement::GetList(null, $filter), null, true, null, false
            );
            return count($res);
        }
