...
$price = $arResult['OFFERS'][0]['PRICES']['Обмен с сайтом']['PRINT_VALUE'];
$array = array();
...
//			$size[]                = $atr[0];
	...
	foreach($array as $vol){
		if(!in_array($vol[1],$colors)){
			$colors[] = $vol[1];
		}
		if(!in_array($vol[0],$size)){
			$size[] = $vol[0];
		}
...
<!--<pre>--><?//print_r($size)?><!--</pre>-->
<!--    --><? // //= count($arResult['OFFERS'])?>
<!--<pre>--><?//print_r($arResult['PROPERTIES'])?><!--</pre>-->

<div class = "main_picture">
	<div class = "big_picture">
		<a href = "<?= $arResult['DETAIL_PICTURE']['SRC'] ?>" class = 'cloud-zoom' id = 'zoom1'
