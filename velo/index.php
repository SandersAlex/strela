...
?> <?
	...
	if (isset($_REQUEST['price_min'])) {
		$arOrder = array("CATALOG_PRICE_1"=>"ASC");
		$arrFilter[] = array(
			'LOGIC' => 'AND',
			array(
...
?> <?$APPLICATION->IncludeComponent("gora:catalog.filter",

	"", Array(), false);?><?$APPLICATION->IncludeComponent("bitrix:catalog.section", "velo_list", array(
	"IBLOCK_TYPE" => "goods",
	"IBLOCK_ID" => "30",
